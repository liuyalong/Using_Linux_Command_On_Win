...
"x86_64-msys-thread-multi-2.11.2(0.32953)" or
	die "Errno architecture (x86_64-msys-thread-multi-2.11.2(0.32953)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
